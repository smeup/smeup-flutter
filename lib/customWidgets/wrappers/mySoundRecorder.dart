...
class MySoundsRecorder extends StatefulWidget {
  @override
  _MySoundsRecorderState createState() => new _MySoundsRecorderState();
}

class _MySoundsRecorderState extends State<MySoundsRecorder> {
