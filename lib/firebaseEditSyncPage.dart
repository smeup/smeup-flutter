...
class FirebaseEditSyncPage extends StatefulWidget {

  final Product _initValues; 

  FirebaseEditSyncPage(this._initValues);

  @override
  _FirebaseEditSyncPageState createState() => _FirebaseEditSyncPageState();
}

class _FirebaseEditSyncPageState extends State<FirebaseEditSyncPage> {
